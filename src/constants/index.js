...
export const translations = {
  en: {
    ...
    landing: {
      ...
      carouselFeature1: 'Drag & Drop Slide Builder',
      carouselFeature2: 'Professional Templates',
      carouselFeature3: 'Export as PDF (1080x1080)',
      carouselCTA: 'Create Carousel',
      // Survey Card (Right)
      offline: 'Offline',
      realtime: 'Real-time',
      surveyTitle: 'Offline Surveys',
      surveyDesc: 'Run surveys at events, conferences or in-person meetings. Collect real feedback without internet dependency.',
      surveyFeature1: 'Works without Internet',
      surveyFeature2: 'QR Code Sharing',
      surveyFeature3: 'Real-time Analytics',
      surveyCTA: 'Create Survey',
      // Stats
      stat1Value: '48h',
    ...
    carousel: {
      ...
      minSlides: 'Minimum 1 slide required',
      noSlides: 'No slides to export',
      untitled: 'Untitled Carousel',
    ...
    // Survey Editor
    survey: {
      savedSurveys: 'Saved Surveys',
      blocks: 'blocks',
      chooseTemplate: 'Choose a Template',
      templateDesc: 'Start with a template for problem or idea validation',
      ...
      scanToOpen: 'Scan this code to open the survey on a mobile device',
      copyLink: 'Copy Link',
      saveQR: 'Save QR',
      results: 'Results',
      responses: 'responses',
      ...
      response: 'Response',
      thankYou: 'Thank You!',
      responsesSaved: 'Your response has been saved.',
  ...
  de: {
    ...
    // Landing Page
    landing: {
      tagline: 'Validierungs-Tools',
      badge: 'Für ambitionierte Gründer',
      headline1: 'Zwei Tools.',
      headline2: 'Ein Ziel: Market-Fit.',
      ...
      carouselFeature1: 'Drag & Drop Slide Builder',
      carouselFeature2: 'Professionelle Templates',
      carouselFeature3: 'Export als PDF (1080x1080)',
      carouselCTA: 'Carousel erstellen',
      // Survey Card (Right)
      offline: 'Offline',
      realtime: 'Echtzeit',
      surveyTitle: 'Offline Umfragen',
      ...
      surveyFeature1: 'Funktioniert ohne Internet',
      surveyFeature2: 'QR-Code Sharing',
      surveyFeature3: 'Echtzeit-Analysen',
      surveyCTA: 'Umfrage erstellen',
      // Stats
      stat1Value: '48h',
      stat1Label: 'Time to Insights',
      stat2Value: '10x',
    ...
    carousel: {
      ...
      save: 'Speichern',
      saved: 'Carousel gespeichert!',
      created: 'Carousel erstellt!',
      saveFailed: 'Speichern fehlgeschlagen: ',
      exported: 'PDF erfolgreich exportiert!',
      exportFailed: 'Export fehlgeschlagen: ',
      loginToSave: 'Bitte anmelden zum Speichern',
      minSlides: 'Mindestens 1 Slide erforderlich',
      noSlides: 'Keine Slides zum Exportieren',
      untitled: 'Unbenanntes Carousel',
      titlePlaceholder: 'Carousel Titel...',
      background: 'Hintergrund',
      chooseBackground: 'Hintergrund wählen',
      newCarousel: 'Neues Carousel',
      deleteCarousel: 'Carousel löschen?',
      slides: 'Slides',
      slideTypes: {
        cover: 'Cover Slide',
        option: 'Option Slide',
        cta: 'CTA Slide',
        stats: 'Statistik Slide',
        quote: 'Zitat Slide',
        comparison: 'Vergleich Slide',
        blank: 'Leere Slide',
      },
    },
    // Survey Editor
    survey: {
      savedSurveys: 'Gespeicherte Umfragen',
      blocks: 'Blöcke',
      chooseTemplate: 'Vorlage wählen',
      templateDesc: 'Starte mit einer Vorlage für Problem- oder Ideen-Validierung',
      addBlocks: 'Blöcke hinzufügen',
      questions: 'Fragen',
      content: 'Inhalt',
      ...
      allowBack: 'Zurück-Navigation erlauben',
      shuffleQuestions: 'Fragen mischen',
      thankYouMessage: 'Danke-Nachricht',
      preview: 'Vorschau',
      shareQR: 'QR-Code teilen',
      scanToOpen: 'Scanne diesen Code, um die Umfrage auf einem mobilen Gerät zu öffnen',
      copyLink: 'Link kopieren',
      saveQR: 'QR speichern',
      results: 'Ergebnisse',
      responses: 'Antworten',
      responsesCollected: 'Antworten gesammelt',
      noResponses: 'Noch keine Antworten',
      response: 'Antwort',
      thankYou: 'Vielen Dank!',
      responsesSaved: 'Ihre Antwort wurde gespeichert.',
