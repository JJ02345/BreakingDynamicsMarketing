...
import { ChevronRight, Linkedin, FileText, Sparkles, MousePointerClick, Shield, Flag, Zap, MessageCircle } from 'lucide-react';
      ...
      <div className="relative z-10 mx-auto max-w-3xl w-full text-center">
        ...
        <div className="animate-slide-up delay-300 mb-12">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link
              to="/chat"
              className="group inline-flex items-center gap-3 px-6 py-4 rounded-2xl font-semibold text-base transition-all bg-white/5 border border-white/10 text-white hover:bg-white/10 hover:border-white/20"
            >
              <MessageCircle className="h-5 w-5 flex-shrink-0 text-[#FF6B35]" />
              <span>{t('landing.aiChat') || 'AI Chat'}</span>
            </Link>
          </div>
