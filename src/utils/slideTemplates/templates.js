export const SLIDE_TEMPLATES = {
  cover: {
    ...
    defaultStyles: { background: 'gradient-orange', padding: 'lg' }
  },
  option: {
    id: 'option',
    name: 'Option Slide',
    ...
    defaultStyles: { background: 'solid-dark', padding: 'lg' }
  },
  comparison: {
    id: 'comparison',
  ...
  stats: {
    ...
    defaultStyles: { background: 'gradient-dark', padding: 'lg' }
  },
  quote: {
    id: 'quote',
    name: 'Quote Slide',
    ...
    defaultStyles: { background: 'gradient-purple', padding: 'lg' }
  },
  cta: {
    id: 'cta',
    name: 'CTA Slide',
  ...
  result: {
    ...
    defaultStyles: { background: 'gradient-emerald', padding: 'lg' }
  },
  myth: {
    id: 'myth',
    name: 'Myth Slide',
    ...
    defaultStyles: { background: 'gradient-fire', padding: 'lg' }
  },
  reality: {
    id: 'reality',
    name: 'Reality Slide',
  ...
  lesson: {
    ...
    defaultStyles: { background: 'gradient-gold', padding: 'lg' }
  },
  opinion: {
    id: 'opinion',
    name: 'Opinion Slide',
  ...
  proof: {
    ...
    defaultStyles: { background: 'gradient-blue', padding: 'lg' }
  },
  aboutIntro: {
    id: 'aboutIntro',
    name: 'About Intro',
  ...
  aboutWhy: {
    ...
    defaultStyles: { background: 'gradient-rose', padding: 'lg' }
  },
  funFact: {
    id: 'funFact',
    name: 'Fun Fact',
    ...
    defaultStyles: { background: 'mesh-vibrant', padding: 'lg' }
  }
};
