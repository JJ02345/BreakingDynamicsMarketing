...
const translations = {
  en: {
    ...
    editor: {
      ...
      saveData: 'Save Data?',
      copyOnly: 'Copy only (without saving)',
  ...
  de: {
    ...
    editor: {
      ...
      copyOnly: 'Nur kopieren (ohne Speichern)',
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 pt-20">
        ...
        <div className="relative z-10 mx-auto max-w-5xl text-center">
          ...
          <div className="animate-slide-up delay-300 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to="/editor" className="btn-primary text-base px-8 py-4 animate-glow-pulse">
              <span className="flex items-center gap-2">
                {t('landing.ctaButton')}
...
const Editor = function(props) {
  ...
  // NEW: Use postCompiler instead of manual genText
  const genText = () => {
  ...
  const finalize = async () => {
    ...
    // Compile with validation using postCompiler
    ...
    // Show warnings (e.g. if LinkedIn limits exceeded)
  ...
  const shareToLinkedIn = () => {
    ...
    // Open LinkedIn share dialog after short delay
    setTimeout(() => {
    ...
    return (
      <div className="min-h-screen bg-[#0A0A0B] p-6 flex items-center justify-center">
        <div className="w-full max-w-xl card-dark p-8 animate-scale-in">
          ...
          {/* Share to LinkedIn Button - Primary CTA */}
          <button 
            onClick={shareToLinkedIn} 
            className="btn-primary w-full justify-center mb-3 !bg-[#0A66C2] hover:!bg-[#004182]"
          >
          ...
          {/* Copy Text Button */}
          <button onClick={copyTxt} className={"btn-secondary w-full justify-center mb-3 " + (copied ? '!border-[#00E676] !text-[#00E676]' : '')}>
          ...
          <div className="flex gap-3">
            <button onClick={handleNewSurvey} className="btn-ghost flex-1 justify-center">{t('editor.newSurvey')}</button>
            {isAuthenticated && <Link to="/dashboard" className="btn-ghost flex-1 justify-center">{t('nav.dashboard')}</Link>}
          </div>
        </div>
      </div>
    );
          ...
          >
            <div className="mx-auto max-w-xl space-y-3">
              ...
              <div className="mt-4 space-y-3 rounded-xl border border-white/10 bg-[#111113] p-4">
                ...
                <button onClick={() => navigate(isAuthenticated ? '/dashboard' : '/')} className="btn-secondary w-full justify-center">
              ...
              <div className="card-dark overflow-hidden">
                {props.surveys.length === 0 ? (
                  <div className="p-12 text-center">
                    ...
                    <Link to="/editor" className="btn-primary mt-6 inline-flex">
