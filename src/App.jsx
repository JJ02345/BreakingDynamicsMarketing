      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 pt-20">
        ...
        <div className="relative z-10 mx-auto max-w-5xl text-center">
          ...
          <div className="animate-slide-up delay-500 mt-12">
            <div className="inline-flex flex-col sm:flex-row items-center gap-4 sm:gap-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm px-6 sm:px-8 py-5">
              <div className="flex -space-x-3">
                {['🚀', '💡', '⚡', '🎯'].map((emoji, i) => (
                  <div key={i} className="w-10 h-10 rounded-full bg-gradient-to-br from-[#FF6B35]/20 to-[#FF8C5A]/20 border-2 border-[#0A0A0B] flex items-center justify-center text-lg">
                    {emoji}
                  </div>
                ))}
              </div>
              <div className="text-center sm:text-left">
                <p className="text-white font-semibold">Werde Teil der Gründer-Community</p>
                <p className="text-white/50 text-sm">Exklusive Insights, Beta-Zugang & direkter Austausch</p>
              </div>
              <a 
